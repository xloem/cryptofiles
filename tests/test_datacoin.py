...
def test_utils():
    ...
    firstgetdata = index(utils.alldatatype(cf, 'getdata', 18580), 0)
    ...
    firstenvelope = index(utils.alldatatype(cf, 'getdata', '523ddc0d2bbea14309ffd6799186eda79d0dd16d9d26399dca96b0af0de3e2a4'), 0)
    assert firstenvelope.parsed.data == b'Hello, World!\n'
